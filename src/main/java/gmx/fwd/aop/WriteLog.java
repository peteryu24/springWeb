...
public class WriteLog {
	...
	*/
	...
	@Pointcut("execution(* gmx.fwd.security.MyUserDetailService.loadUserByUsername(String))")
	private void forSecurityLogin() {
	}
	...
	@AfterReturning("forSecurityLogin()")
	public void loginSuccessful(JoinPoint joinPoint) {
		...
		loginLog.setUsername((String) loginInfoList.get(0));
